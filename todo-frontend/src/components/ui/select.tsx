  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={`
        ...
        text-popover-foreground shadow-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={`
        ...
        py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none 
